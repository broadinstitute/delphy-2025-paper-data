...
tMRCAs_BEAST = extract_tMRCA_distr(f'./beast_run/Mpox_2poch_combined.log', burnin=0.30)
for run in ('a', 'b'):
...
plot_tree(f'./beast_run/mpox-parker-2025-beast.mcc', f'plots/BeastMcc-ByRegion.pdf', tMRCAs, tMRCAs_BEAST,
          mapper=lambda n : region_of(shorten_id(n)), color_palette=region_2_color)
plot_tree(f'./beast_run/mpox-parker-2025-beast.mcc', f'plots/BeastMcc-ByPseudoRegion.pdf', tMRCAs, tMRCAs_BEAST,
