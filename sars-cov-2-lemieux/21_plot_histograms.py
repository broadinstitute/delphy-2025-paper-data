...
ml_results = extract_ml_results('ml/ma_sars_cov_2.iqtree', 'ml/tt', False)
compare_logs(
    './delphy_outputs_a/ma_sars_cov_2_delphy.log',
...
compare_logs(
    './delphy_outputs_b/ma_sars_cov_2_delphy.log',
    'beast2_run/output.log',
...
ml_results_alpha = extract_ml_results('ml/ma_sars_cov_2_alpha.iqtree', 'ml/tt', True)
compare_logs(
    './delphy_outputs_alpha_a/ma_sars_cov_2_delphy_alpha.log',
...
compare_logs(
    './delphy_outputs_alpha_b/ma_sars_cov_2_delphy_alpha.log',
    'beast2_run_alpha/output.log',
