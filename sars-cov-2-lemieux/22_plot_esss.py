...
wallclock_delphy_min = 9 + 9.493/60.0
wallclock_beast2_min = 1613 + 58.484/60.0

compare_logs(
    './delphy_outputs_a/ma_sars_cov_2_delphy.log', wallclock_delphy_min,
    'beast2_run/output.log', wallclock_beast2_min,
    'plots/ESSDelphyAVsBeast2.pdf',
    burnin=0.30
)

wallclock_delphy_min = 9 + 8.553/60.0
wallclock_beast2_min = 1613 + 58.484/60.0

compare_logs(
    './delphy_outputs_b/ma_sars_cov_2_delphy.log', wallclock_delphy_min,
    'beast2_run/output.log', wallclock_beast2_min,
...
wallclock_delphy_alpha_min = 11 + 27.308/60.0
wallclock_beast2_alpha_min = 3880 + 46.402/60.0

compare_logs(
    './delphy_outputs_alpha_a/ma_sars_cov_2_delphy_alpha.log', wallclock_delphy_alpha_min,
    'beast2_run_alpha/output.log', wallclock_beast2_alpha_min,
    'plots/ESSDelphyAVsBeast2Alpha.pdf',
    burnin=0.30
)

wallclock_delphy_alpha_min = 11 + 26.649/60.0
wallclock_beast2_alpha_min = 3880 + 46.402/60.0

compare_logs(
    './delphy_outputs_alpha_b/ma_sars_cov_2_delphy_alpha.log', wallclock_delphy_alpha_min,
    'beast2_run_alpha/output.log', wallclock_beast2_alpha_min,
