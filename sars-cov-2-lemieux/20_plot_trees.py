...
def plot_tree(mcc_filename, out_pdf_filename):
    ...
    ax.legend(custom_lines, custom_labels, bbox_to_anchor=(0.55, 0.98), framealpha=0.5)
...
plot_tree('./delphy_outputs_a/ma_sars_cov_2_delphy.mcc', 'plots/DelphyAMcc.pdf')
plot_tree('./delphy_outputs_b/ma_sars_cov_2_delphy.mcc', 'plots/DelphyBMcc.pdf')
plot_tree('./delphy_outputs_alpha_a/ma_sars_cov_2_delphy_alpha.mcc', 'plots/DelphyAMccAlpha.pdf')
