...
wallclock_delphy_min = 6 + 28.040/60.0
wallclock_beast2_min = 70 + 46.480/60.0

compare_logs(
    './delphy_outputs_a/ebola_delphy.log', wallclock_delphy_min,
    'beast2_run/output.log', wallclock_beast2_min,
    'plots/ESSDelphyAVsBeast2.pdf',
    burnin=0.30
)

wallclock_delphy_min = 6 + 25.030/60.0
wallclock_beast2_min = 70 + 46.480/60.0

compare_logs(
    './delphy_outputs_b/ebola_delphy.log', wallclock_delphy_min,
    'beast2_run/output.log', wallclock_beast2_min,
    'plots/ESSDelphyBVsBeast2.pdf',
    burnin=0.30
)

wallclock_delphy_alpha_min = 11 + 43.906/60.0
wallclock_beast2_alpha_min = 83 + 38.563/60.0

compare_logs(
    './delphy_outputs_alpha_a/ebola_delphy_alpha.log', wallclock_delphy_alpha_min,
    'beast2_run_alpha/output.log', wallclock_beast2_alpha_min,
    'plots/ESSDelphyAVsBeast2Alpha.pdf',
    burnin=0.30
)

wallclock_delphy_alpha_min = 11 + 46.020/60.0
wallclock_beast2_alpha_min = 83 + 38.563/60.0

compare_logs(
    './delphy_outputs_alpha_b/ebola_delphy_alpha.log', wallclock_delphy_alpha_min,
    'beast2_run_alpha/output.log', wallclock_beast2_alpha_min,
