...
compare_logs(
    './delphy_outputs_a/ebola_delphy.log',
...
compare_logs(
    './delphy_outputs_b/ebola_delphy.log',
    'beast2_run/output.log',
...
compare_logs(
    './delphy_outputs_alpha_a/ebola_delphy_alpha.log',
...
compare_logs(
    './delphy_outputs_alpha_b/ebola_delphy_alpha.log',
    'beast2_run_alpha/output.log',
